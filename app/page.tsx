		...
		<main>
			...
			>
				...
				<div className="flex flex-col md:gap-20 md:justify-between items-center md:flex-row">
					...
					/>
					<div>
						<h1 className="mt-8 max-w-xl text-center font-accent text-6xl [word-spacing:-10px] md:[word-spacing:-20px] font-bold uppercase italic !leading-[1.15] text-slate-200 drop-shadow-lg md:text-left md:text-8xl">
							We are{" "}
