...
export default function Navbar() {
	...
	return (
		<nav className="flex flex-col items-stretch justify-between py-4 lg:py-0 gap-x-14 bg-white text-slate-700 lg:flex-row lg:items-center lg:mt-0 border-t-[2rem] border-black md:px-20">
			...
			<ul className="hidden flex-col bg-white text-2xl lg:text-5xl mt-4 lg:mt-0 font-accent tracking-wide font-bold text-black uppercase divide-y-2 lg:divide-y-0 shadow-sm peer-checked:flex lg:flex lg:flex-row lg:divide-x-2 divide-zinc-100 lg:bg-transparent lg:shadow-none">
